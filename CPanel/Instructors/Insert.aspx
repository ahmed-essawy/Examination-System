...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    <form id="form1" runat="server">
        ...
        <table style="width: 98%;">
            ...
            <tr>
                <td style="height: 35px; width: 139px">First Name:</td>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="DP_Name_drop" runat="server" AutoPostBack="True" Style="width: 50%; height: 42px" Width="236px" BackColor="White" DataSourceID="Departments" DataTextField="DP_Name" DataValueField="DP_ID">
                    </asp:DropDownList>
