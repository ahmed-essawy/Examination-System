<%@ Page Title="" Language="C#" MasterPageFile="~/CPanel/MP/anonymous.master" AutoEventWireup="true" CodeFile="Select.aspx.cs" Inherits="CPanel_Choices" %>
    ...
    <form id="form1" runat="server">
        ...
        <table style="width: 50%;">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID=Choice1 runat="server" ReadOnly="True"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID=Choice2 runat="server" ReadOnly="True"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID=Choice3 runat="server" ReadOnly="True"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID=Choice4 runat="server" ReadOnly="True"></asp:TextBox>
                </td>
            </tr>
        </table>
    </form>
